---
name: marketing-campaign-architecture
...
| Video Teaser | Hook with the Big Promise | "What if you could [result]?" |

### Phase 2: Educate (Days 4-7)
**Goal**: Teach the unique mechanism

| Content Type | Purpose | Example |
|--------------|---------|---------|
| Training Video | Explain the mechanism | "The 3 secrets behind [result]" |
| Blog Post | Deep dive on methodology | "Why [old approach] doesn't work" |
| Email Series | Break false beliefs | "The truth about [topic]" |

### Phase 3: Engage (Days 8-10)
**Goal**: Build relationship and handle objections

| Content Type | Purpose | Example |
|--------------|---------|---------|
| Q&A Session | Answer questions live | "Ask me anything about [topic]" |
| Case Study | Show real results | "How [person] achieved [result]" |
| Objection Email | Address concerns | "Is this right for you?" |

### Phase 4: Establish (Days 11-13)
**Goal**: Prove the solution works

| Content Type | Purpose | Example |
|--------------|---------|---------|
| Testimonial Compilation | Stack social proof | "What our clients say" |
| Results Showcase | Demonstrate outcomes | "30 success stories in 30 days" |
| Expert Endorsement | Third-party validation | "[Expert] recommends [solution]" |

### Phase 5: Execute (Days 14-17)
**Goal**: Drive action with urgency

| Content Type | Purpose | Example |
|--------------|---------|---------|
| Offer Reveal | Present the full offer | "Here's everything you get" |
| Urgency Emails | Create deadline pressure | "Only 48 hours left" |
| Final Call | Last chance messaging | "Doors close at midnight" |

## Big Marketing Idea Development Process

### Step 1: Identify the Big Promise
- What is the primary transformation?
- What result will they achieve?
- How will their life be different?

### Step 2: Discover the Unique Mechanism
- What makes your approach different?
- What's the "secret" or "discovery"?
- Why does your method work when others don't?

### Step 3: Name the Mechanism
- Give it a proprietary name
- Make it memorable and intriguing
- Examples: "The E5 Method," "The Perfect Webinar," "The Value Ladder"

### Step 4: Develop the Unique Sales Argument
- Why is this mechanism superior?
- What does it do that alternatives can't?
- Why should they choose this over everything else?

### Step 5: Create Proof for the Mechanism
- Case studies showing the mechanism in action
- Testimonials specifically about the mechanism
- Demonstrations of how it works

## Campaign Messaging Architecture Template

### Campaign Theme
- **Big Promise**: [The primary transformation]
- **Unique Mechanism**: [The proprietary process]
- **Unique Sales Argument**: [Why this is superior]
- **Enemy**: [What your mechanism defeats]
- **Market Sophistication Level**: [1-5]

### Messaging by Phase

**Excite Phase Messaging**:
- Hook: [Pattern interrupt or curiosity trigger]
- Promise: [What's possible with this new opportunity]
- Tease: [What's coming without revealing everything]

**Educate Phase Messaging**:
- Problem: [Why the old approach doesn't work]
- Discovery: [The breakthrough or insight]
- Mechanism: [How your approach works differently]

**Engage Phase Messaging**:
- Connection: [Relate to their situation]
- Objections: [Address concerns directly]
- Community: [Show others on the same journey]

**Establish Phase Messaging**:
- Proof: [Stack testimonials and case studies]
- Credibility: [Your authority and expertise]
- Results: [Specific outcomes achieved]

**Execute Phase Messaging**:
- Offer: [Everything they get]
- Value: [Why it's worth more than the price]
- Urgency: [Why they must act now]
- CTA: [Exactly what to do next]

## Step-by-Step Workflow

1. **Research the Market**: Understand the audience, competitors, and market sophistication level.

2. **Develop the Big Marketing Idea**: Define Big Promise, Unique Mechanism, and Unique Sales Argument.

3. **Name Your Mechanism**: Create a proprietary, memorable name for your process.

4. **Map the E5 Sequence**: Plan content for each phase: Excite, Educate, Engage, Establish, Execute.

5. **Create the Content**: Develop all campaign assets (emails, videos, posts, ads).

6. **Build the Campaign Calendar**: Schedule all touchpoints on a timeline.

7. **Set Up Tracking**: Implement analytics to measure each phase's performance.

8. **Execute the Campaign**: Launch and monitor daily.

9. **Optimize in Real-Time**: Adjust messaging based on engagement and conversion data.

10. **Debrief and Document**: Analyze results and capture learnings for future campaigns.

## Examples

**Example 1: Course Launch Campaign**
- Big Promise: "Build a 6-figure online course business"
- Unique Mechanism: "The Course Creation Accelerator Method"
- Unique Sales Argument: "The only system that validates, creates, and launches in 30 days"
- E5 Sequence: 14-day campaign with 3 training videos + 5-day open cart

**Example 2: SaaS Product Campaign**
- Big Promise: "Double your team's productivity"
- Unique Mechanism: "The Async-First Workflow System"
- Unique Sales Argument: "Eliminates 80% of meetings while improving collaboration"
- E5 Sequence: 10-day campaign with demo + case studies + free trial offer

## Pro Tips from the Experts

**Todd Brown**: "The Big Marketing Idea is everything. Without a unique mechanism, you're just another voice in a crowded market making the same claims as everyone else."

**Eugene Schwartz**: "As markets mature, you must evolve your messaging. What worked at Level 1 won't work at Level 5. Match your sophistication to the market."

**Robert Cialdini**: "The best persuasion happens before you make your pitch. Pre-suasion sets up the sale so the close feels natural."

**Dan Kennedy**: "Every campaign needs an enemy. Not a competitor, but a concept or approach that your solution defeats. Give them something to fight against."
